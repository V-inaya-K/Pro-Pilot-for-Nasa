...
function App() {
  ...
  <h1 className="text-2xl font-bold text-white">Pro Pilot Dashboard</h1>
        ...
        <div className="flex items-center space-x-6 text-white">
          <a href="#" className="text-xl hover:text-white transition-colors">Home</a>
          <a href="#" className="text-xl hover:text-white transition-colors">Trending</a>
          <a href="#" className="text-xl hover:text-white transition-colors">Community</a>
          <a href="#" className="text-xl hover:text-white transition-colors">Profile</a>
...
>
  ...
  {availableInterests.map((category) => (
    <option key={category} value={category}>
      ...
      <input
        type="text"
        placeholder="Author"
        className="w-full px-3 py-2 rounded-lg bg-gray-800 text-white placeholder-blue-200"
      />
    </div>
  ...
  <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/10 max-h-[400px] overflow-y-auto">
    ...
    {documents.slice(-4).map((doc) => (
      <div
        key={doc.id}
        className="p-2 text-blue-200 hover:text-white cursor-pointer border-b border-white/10"
